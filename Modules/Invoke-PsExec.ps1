...
<#
.SYNOPSIS
Invoke-PsExec performs PsExec style command execution with pass the hash authentication over NTLMv2. Invoke-PsExec
...
.EXAMPLE
Invoke-PsExec -Target 192.168.100.20 -Domain TESTDOMAIN -Username TEST -Hash F6F38B793DB6A94BA04A52F1D3EE92F0 -Command "command to execute"

.EXAMPLE
Invoke-PsExec -Target 192.168.100.20 -Domain TESTDOMAIN -Username TEST -Password 'Pa55w0rd1!' -Command "command to execute"
