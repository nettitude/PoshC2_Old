...
#This function is provided by Richard Siddaway - https://richardspowershellblog.wordpress.com/2011/07/23/moving-windows/    
...
$horiz = ($video.CurrentHorizontalResolution/2)
move-window -newx $horiz -newy 0

$console = $host.UI.RawUI
$buffer = $console.BufferSize
$half = ((($console.maxphysicalwindowsize.width)/2)-10)
$buffer.Width = $half
$buffer.Height = 1000
$console.BufferSize = $buffer
$size = $console.WindowSize
$size.Width = $half
$size.Height = (($console.maxphysicalwindowsize.height)-1)
$console.WindowSize = $size
$console.windowtitle = 'Implant Handler'
